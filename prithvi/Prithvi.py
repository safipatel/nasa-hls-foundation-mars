...
class MaskedAutoencoderViT(nn.Module):
    ...
    def forward_encoder(self, x, mask_ratio,mask_noise=None):
        ...
        x, mask, ids_restore,noise = self.random_masking(x, mask_ratio,mask_noise = mask_noise)
    ...
    def forward(self, imgs, mask_ratio=0.75,mask_noise = None):
        latent, mask, ids_restore,noise = self.forward_encoder(imgs, mask_ratio,mask_noise=mask_noise)
        pred = self.forward_decoder(latent, ids_restore)
        loss = self.forward_loss(imgs, pred, mask)
        return loss, pred, mask,noise
