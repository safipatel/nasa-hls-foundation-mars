...
save_path = work_dir
train_pipeline = [
    dict(type="LoadGeospatialImageFromFile", to_float32=image_to_float32), #TODO: change this and the one below to instead load from jpg and multiply to be like HLS data. 
    dict(type="LoadGeospatialAnnotations", reduce_zero_label=False), #TODO make sure you're loading annotations in the same way as these guys 
...
test_pipeline = [
    dict(type="LoadGeospatialImageFromFile", to_float32=image_to_float32), #TODO: same thing here
    dict(type="BandsExtract", bands=bands),
